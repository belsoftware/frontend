...
const withoutAuthorization = (redirectionUrl) => (Component) => {
  ...
  const mapStateToProps = (state) => {
    ...
    const ulbLogo = userTenant.length > 0 ? get(userTenant[0], "logoId") : "https://raw.githubusercontent.com/belegovgithub/egov-mdms-data/BEL-CB-Impl/data/pb/images/dgde-logo.png";

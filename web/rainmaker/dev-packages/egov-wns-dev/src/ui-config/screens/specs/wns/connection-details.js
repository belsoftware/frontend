  ...
  if (service === "SEWERAGE") {
    ...
    if (payloadData !== null && payloadData !== undefined && payloadData.SewerageConnections.length > 0) {
      ...
      if (payloadData.SewerageConnections[0].property.usageCategory !== undefined) {
        ...
        let propertyUsageTypeParams = { MdmsCriteria: { tenantId: tenantId, moduleDetails: [{ moduleName: "PropertyTax", masterDetails: [{ name: "UsageCategoryMajor", filter: `${propertyUsageType}` }] }] } }
